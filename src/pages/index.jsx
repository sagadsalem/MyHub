...
import qiLogo from '@/images/companies/qi.png'
import enjazLogo from '@/images/companies/enjaz.png'
import beladiLogo from '@/images/companies/beladi.png'
import phoenixLogo from '@/images/companies/phoenix.png'
import hrinsLogo from '@/images/companies/hrins.png'
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Sajad Salem - Software Artisan, Doting Father, Man Utd Fan
        </title>
        <meta
          name="description"
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/sagad_salem"
              aria-label="Follow on Twitter"
              icon={TwitterIcon}
            />
            <SocialLink
              href="https://instagram.com/sagad_salem"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/sagadsalem"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://linkedin.com/in/sajad-salem-829113133/"
